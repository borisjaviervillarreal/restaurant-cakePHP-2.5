                  ...
                  <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <?php echo $this->Form->input('role', array('class' => 'form-control', 'label' => '', 'type' => 'select', 'options' => array('admin' => 'Administrador', 'user' => 'Usuario', 'repartidor'=>'Repartidor'), array('class' => 'form-control')));?>
                      </div>
                    </div>
                    <div class="form-group">
