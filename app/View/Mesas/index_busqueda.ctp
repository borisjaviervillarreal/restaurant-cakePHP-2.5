...
<div class="col-md-12">
	...
	<tr>
		...
		<td><?php if ($mesa['Mesa']['estado_id']==3){echo "Despachado";}
		if ($mesa['Mesa']['estado_id']==0){echo "No Despachado";}
			if ($mesa['Mesa']['estado_id']==1){echo "Entregado";} ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__(''), array('action' => 'view', $mesa['Mesa']['id']),array('class' => 'btn glyphicon glyphicon-eye-open','title'=>'Ver Datos del Despacho'));?>
