...
<div class="page-header">
	<h2><?php echo __('Despachos Asignados No Entregados:'); ?></h2>
</div>
...
<div class="col-md-12">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__(''), array('action' => 'view', $mesa['Mesa']['id']),array('class' => 'btn glyphicon glyphicon-eye-open','title'=>'Ver'));?>
			<?php echo $this->Html->link(__(''), array('action' => 'edit', $mesa['Mesa']['id']),array('class' => 'btn glyphicon glyphicon-pencil','title'=>'Editar'));?>
